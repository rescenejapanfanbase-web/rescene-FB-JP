(()=>{
  ...
  function injectControls(){
    ...
    if(menu&&!menu.querySelector('.language-mobile-block')){
      const block=document.createElement('div');block.className='language-mobile-block';block.innerHTML=`<span class="language-title">LANGUAGE</span><div class="language-options">${languageButtons()}</div><small class="language-status" data-language-status hidden></small>`;menu.insertBefore(block,menu.firstChild);
    }
