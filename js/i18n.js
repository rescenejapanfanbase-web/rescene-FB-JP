(()=>{
  ...
  function init(){
    ...
    ['rescene:content-updated','rescene:content-rendered'].forEach(name=>document.addEventListener(name,()=>{if(currentLanguage!=='jp')applyLanguage(currentLanguage,{userActivated:false})}));
  }
